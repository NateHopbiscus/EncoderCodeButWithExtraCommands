...
//Motor Selection States, used for Joystick.
#define BASE 10
#define LOWERARM 11
#define UPPERARM 12
#define WRISTONE 13
...
//Switch States for Control Schemes
#define JOYSTICK 20
#define KEYPAD 21

//Edit Switch States in Keypad
#define MOTORSELECTEDIT 25
#define DIRECTIONSELECTEDIT 26
#define VALUESELECTEDIT 27
#define RESTART 28

//Value Edit Switch States
...
int excurrentCount = 0;
int expreviousCount = 0;
...
void loop() {
  ...
  switch (control) {
    //Activated with button on Pin 21
    //Joystick is an Analog Joystick
    case JOYSTICK:
      {
        if (key == 17) {
          motor = BASE;
    ...
    //Keypad Code
    //Excessively Long, but responsible for keypad use,
    //Runs through selections of Motor, Direction, and Movement Values
    //Edit Function + Verification Function
    //Multiple Command Function WIP.
    case KEYPAD:
      {
        display.clearDisplay();
        display.setTextSize(1);
          ...
          case VERIFY:
            ...
            display.print("The ");
            {
              ...
              if (key == 1 && EXComm == 0) {
                ...
                display.setTextColor(WHITE);
                display.setCursor(1, 0);
                display.print("Would you like to add a secondary command?");
                display.setTextSize(1);

                display.setCursor(1, 55);
                display.print("A/Confirm | B/Deny");
                display.display();
                ...
                display.setTextColor(WHITE);
                display.setCursor(1, 0);
                display.print("Would you like to verify your secondary command?");
                display.setTextSize(1);
            ...
            case EXCOMMAND:
              switch (exstate) {
                ...
                case DIRECTION:
                  ...
                  display.setTextColor(WHITE);
                  display.setCursor(1, 0);
                  display.print("Select EX Direction.");
                  display.setCursor(1, 10);
                  display.print("0. Forward");
                  display.setCursor(1, 20);
                  display.print("1. Reverse");
                ...
                case VERIFY:
                  ...
                  display.setTextColor(WHITE);
                  display.setCursor(1, 0);
                  display.print("Is the secondary command correct?");
                  display.setTextSize(1);
                  display.setCursor(1, 20);
                  display.print("The ");
                  {
                    ...
                    display.print(" will move ");
                    display.print(exhVal);
                    display.print(extVal);
                    display.print(exoVal);
                    display.print(" steps");
                    if (exdVal == 1) {
                      display.print(" forward.");
                    } if (exdVal == -1) {
